...
class CreateAssetTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_asset(self):
        response = await self.requests.make_request('create_asset', {'symbol': "ETH", 'pairs': [], 'qty': 1000, 'seed_price': 50000, 'seed_bid': 0.99, 'seed_ask': 1.01}, self.mock_requester)
        ...
        self.assertEqual(response['type'], "crypto")
...
class LimitBuyTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_limit_buy(self):
        response = await self.requests.make_request('limit_buy', {'base': "BTC", 'quote': "USD", 'price': 149, 'qty': 2, 'creator': self.mock_requester.responder.agent, 'fee': 0.0}, self.mock_requester)
        order = response
...
class LimitSellTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_limit_sell(self):
        response = await self.requests.make_request('limit_sell', {'base': "BTC", 'quote': "USD", 'price': 151.5, 'qty': 1, 'creator': 'init_seed_BTCUSD', 'fee': 0.0}, self.mock_requester)
        order = response
        self.assertEqual(order['ticker'], "BTCUSD")
...
class CancelAllOrdersTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_cancel_all_orders(self):
        ...
        self.assertEqual(response, {'cancelled_all_orders': 'BTCUSD'})
...
class GetAssetsTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_assets(self):
        ...
        self.assertEqual(response, {'assets': {'BTC': 1000, 'USD': 150000}})
...
class MarketBuyTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_market_buy(self):
        response = await self.requests.make_request('market_buy', {'base': "BTC", 'quote': "USD", 'qty': 1, 'buyer': self.mock_requester.responder.agent, 'fee': 0.0}, self.mock_requester)
        self.assertEqual(response, {'market_buy': 'BTCUSD', 'buyer': self.mock_requester.responder.agent, 'fills': [{'qty': 1, 'price': 151.5, 'fee': 0.0}]})
...
class MarketSellTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_market_sell(self):
        response = await self.requests.make_request('market_sell', {'base': "BTC", 'quote': "USD", 'qty': 1, 'seller': 'init_seed_BTCUSD', 'fee': 0.0}, self.mock_requester)
        self.assertEqual(response, {'market_sell': 'BTCUSD', 'seller': 'init_seed_BTCUSD', 'fills': [{'qty': 1, 'price': 151, 'fee': 0.0}]})
...
class GetAgentTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_agent(self):
        ...
        self.assertEqual(response['assets'], {'USD' : 100000})
        self.assertEqual(response['_transactions'], [])
...
class GetAgentsTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_agents(self):
        ...
        self.assertEqual(response[1]['assets'], {'USD': 100000})
...
class AddCashTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_cash(self):
        ...
        self.assertEqual(response, {'USD': 101000})
...
class RemoveCashTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_remove_cash(self):
        ...
        self.assertEqual(response, {'USD': 99000})
...
class GetAgentsPositionsTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_agents_positions(self):
        ...
        self.assertEqual(result[0]['positions'][0]['enters'][0]['quote_flow'], -150000)
        self.assertEqual(result[0]['positions'][0]['enters'][0]['base'], 'BTC')
        self.assertEqual(result[0]['positions'][0]['enters'][0]['initial_qty'], 1000)
        self.assertEqual(result[0]['positions'][0]['enters'][0]['qty'], 0)
        ...
        self.assertEqual(result[0]['positions'][0]['exits'][0]['qty'], 1000)
        self.assertEqual(result[0]['positions'][0]['dt'], '2023-01-01 00:00:00')
...
class GetAgentSimpleTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_agent_simple(self):
        ...
        self.assertCountEqual(result, [{'agent': 'init_seed_BTCUSD', 'assets': {'BTC': 1000, "USD": 150000}}, {'agent': self.mock_requester.responder.agent, 'assets': {'USD': 100000}}])
...
class GetPositionsTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_positions(self):
        ...
        self.assertEqual(result['positions'][0]['enters'][0]['base'], 'USD' )
