...
class ConstantProduct:
    def __init__(self, reserve_a, reserve_b):
        ...
        self.k = non_zero_prec(reserve_a * reserve_b)
        self.fees = {}
    ...
    def get_price(self, delta_a):
        ...
        """
        new_reserve_a = non_zero_prec(self.reserve_a + delta_a)
        new_reserve_b = non_zero_prec(self.k / new_reserve_a)
        delta_b = non_zero_prec(self.reserve_b - new_reserve_b)
        return delta_b
    ...
    def get_total_reserves(self):
        ...
        """
        return non_zero_prec(self.reserve_a + self.reserve_b)
